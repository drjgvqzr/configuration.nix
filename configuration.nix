{
    ...
    systemd.services.ticker = {
        script = ''curl -s https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=WEBN.DEX&apikey=$(cat /home/soma/dx/nixos/misc/secrets/alphavantage) | jq -r '."Global Quote"."05. price"' | sed 's/0*$/€/' > /home/soma/webn '';
        startAt = "daily";
    };
    services = {
        auto-cpufreq = {
