    ...
    home-manager.users.soma.wayland.windowManager.sway = {
        ...
        config = {
            ...
            keybindings = {
                ...
                "mod1+k" = "exec swaymsg '[app_id=\"org.keepassxc.KeePassXC\"] scratchpad show, move position center' || exec keepassxc /home/soma/dx/Backups/Keepass/keepass.kdbx ; exec swaymsg 'workspace number 11'";
